...
const QUESTION_BANKS = {
  ...
  // ── play-1: Suit Combinations ─────────────────────────────────────────────
  "play-1": [
    { type:"play", contract:"3NT", declarer:"South", lead:"♠6", dummy:{spades:"K73",hearts:"A74",diamonds:"32",clubs:"865"}, hand:{spades:"A84",hearts:"K65",diamonds:"AQ4",clubs:"KQ4"}, question:"West leads ♠6. You win ♠A. In diamonds, you hold AQ4 in hand and 32 in dummy, missing the King. What is the best way to win two diamond tricks?", options:["Lead small from dummy and finesse the Queen","Cash the Ace and hope the King drops","Lead the Queen from hand","Duck the lead and wait"], correct:"Lead small from dummy and finesse the Queen", explanation:"With the AQ combination, the best play is to lead small from dummy and finesse the Queen to capture the King if it is onside.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠J", dummy:{spades:"5432",hearts:"A73",diamonds:"82",clubs:"KQ105"}, hand:{spades:"AK6",hearts:"K52",diamonds:"KQ105",clubs:"82"}, question:"West leads ♠J (you win ♠K). In diamonds, you hold KQ105 in hand and 82 in dummy, missing the Ace. You need 2 tricks. What is the best play?", options:["Lead small from dummy and finesse the King","Cash the King first","Lead the 10 from hand","Lead the Queen from hand"], correct:"Lead small from dummy and finesse the King", explanation:"With the KQ tenace, leading small from dummy and finessing the King is the most reliable way to capture the Ace if it is onside.", points:15 },
    { type:"play", contract:"4♠", declarer:"South", lead:"♦Q", dummy:{spades:"K43",hearts:"A54",diamonds:"K43",clubs:"Q543"}, hand:{spades:"AJ1074",hearts:"K32",diamonds:"AJ1074",clubs:"A2"}, question:"In 4♠, West leads ♦Q (you win ♦A). In diamonds, you hold AJ1074 in hand and K43 in dummy, missing the Queen. You want to win all tricks. What is the best way to capture the Queen?", options:["Cash the King first, then finesse the Jack","Lead the Jack from hand immediately","Lead small from dummy and finesse the 10","Cash the 10 then the Jack"], correct:"Cash the King first, then finesse the Jack", explanation:"With a high sequence like AJ10, the best percentage play is to cash the King first to see if the Queen drops, then finesse the remaining honor.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠J", dummy:{spades:"A54",hearts:"AK3",diamonds:"74",clubs:"AJ65"}, hand:{spades:"K32",hearts:"Q54",diamonds:"AQ105",clubs:"Q432"}, question:"In 3NT, West leads ♠J (you win ♠K). In diamonds, you hold AQ105 in hand and 74 in dummy, missing the King and Jack. You need 3 tricks. How should you play?", options:["Finesse the 10 first; if it loses, then you finesse the Queen the second round of the suit.","Cash the Ace then the 10","Lead the Queen from hand","Cash the 10 then the Queen"], correct:"Finesse the 10 first; if it loses, then you finesse the Queen the second round of the suit.", explanation:"The AQ10 combination missing both the King and Jack requires a double finesse to maximize tricks. Finessing the 10 first allows you to capture the Jack; if it loses to the Jack, you still have the chance to finesse the Queen for the King.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠6", dummy:{spades:"K73",hearts:"A74",diamonds:"QJ74",clubs:"865"}, hand:{spades:"A84",hearts:"K65",diamonds:"A432",clubs:"KQ4"}, question:"West leads ♠6. You win ♠A. In diamonds, you hold A432 in hand and QJ74 in dummy, missing the King. What is the best way to win the most tricks in this suit?", options:["First cash the Ace and after that small to the Queen","Lead small from both hands","Lead A and then cash the Q","Cash the Queen first"], correct:"First cash the Ace and after that small to the Queen", explanation:"The optimal line is to cash the Ace first to account for the possibility of a singleton King (the 'drop'). If the King does not fall, you maintain the tenace in the dummy and can then lead small from your hand to finesse the Queen for the King.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠6", dummy:{spades:"K73",hearts:"A74",diamonds:"Q32",clubs:"865"}, hand:{spades:"A84",hearts:"K65",diamonds:"K78",clubs:"KQ4"}, question:"West leads ♠6. You win ♠A. In diamonds, you hold K78 in hand and Q32 in dummy, missing the Ace and Jack. What is the best way to win as many tricks as possible in this suit?", options:["small to K or Q , then small from both hands","Cash the King first","Lead the Queen first","Lead small from hand and finesse the Queen"], correct:"small to K or Q , then small from both hands", explanation:"With the King and Queen split between the two hands, the best play is to lead small to either honor to win the first trick, and then lead small again from both hands to maximize the chance of the Ace to drop.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠6", dummy:{spades:"K73",hearts:"A74",diamonds:"Q765",clubs:"865"}, hand:{spades:"A84",hearts:"K65",diamonds:"K1032",clubs:"KQ4"}, question:"West leads ♠6. You win ♠A. In diamonds, you hold K1032 in hand and Q765 in dummy, missing the Ace and Jack. What is the best way to win as many tricks as possible in this suit?", options:["small to Q , then small to 10","Cash the King first","Lead the 10 first","Lead small from hand and finesse the Queen"], correct:"small to Q , then small to 10", explanation:"With K10 and Q, the best play is to lead small to the Queen first to win a trick. Then, lead small again from dummy and play the 10 to capture the Jack if it is onside.", points:15 },
  ],

...
const QUESTION_BANKS = {
  ...
  "play-1": [
    { type:"play", contract:"3NT", declarer:"South", lead:"♠6", dummy:{spades:"K73",hearts:"A74",diamonds:"32",clubs:"865"}, hand:{spades:"A84",hearts:"K65",diamonds:"AQ4",clubs:"KQ4"}, question:"West leads ♠6. You win ♠A. In diamonds, you hold AQ4 in hand and 32 in dummy, missing the King. What is the best way to win two diamond tricks?", options:["Lead small from dummy toward the AQ (finesse the King)","Cash the Ace and hope the King drops","Lead the Queen from hand","Duck the lead and wait"], correct:"Lead small from dummy toward the AQ (finesse the King)", explanation:"The AQ combination is a classic tenace. Leading toward it wins two tricks if the King is onside (held by West), with a 50% success rate.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠J", dummy:{spades:"5432",hearts:"A73",diamonds:"KJ5",clubs:"AQ6"}, hand:{spades:"AK6",hearts:"K52",diamonds:"82",clubs:"KQ105"}, question:"West leads ♠J (you win ♠K). In clubs, you hold KQ105 in hand and 82 in dummy, missing the Ace. You need 2 tricks. What is the best play?", options:["Lead small from dummy toward the KQ (finesse the Ace)","Cash the King first","Lead the 10 from hand","Lead the Queen from hand"], correct:"Lead small from dummy toward the KQ (finesse the Ace)", explanation:"Leading toward the KQ tenace is the most reliable way to win two tricks, as it captures the Ace if it is onside (West).", points:15 },
    { type:"play", contract:"4♠", declarer:"South", lead:"♦Q", dummy:{spades:"K43",hearts:"A54",diamonds:"K76",clubs:"Q543"}, hand:{spades:"AJ1074",hearts:"K32",diamonds:"A52",clubs:"A2"}, question:"In 4♠, West leads ♦Q (you win ♦A). In trumps, you hold AJ1074 in hand and K43 in dummy, missing the Queen. You want to win all tricks. What is the best way to capture the Queen?", options:["Cash ♠A and ♠K first, then finesse the J","Lead the J from hand immediately","Lead small from dummy and finesse the 10","Cash the 10 then the J"], correct:"Cash ♠A and ♠K first, then finesse the J", explanation:"With a high sequence like AJ10, the best percentage play is to cash the top honors first to see if the Queen drops, then finesse the remaining honor.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠J", dummy:{spades:"A54",hearts:"AK3",diamonds:"74",clubs:"AJ65"}, hand:{spades:"K32",hearts:"Q54",diamonds:"AQ105",clubs:"Q432"}, question:"In 3NT, West leads ♠J (you win ♠K). In diamonds, you hold AQ105 in hand and 74 in dummy, missing the King and Jack. You need 3 tricks. How should you play?", options:["Lead small from dummy and finesse the Q","Cash the Ace then the 10","Lead the Q from hand","Cash the 10 then the Q"], correct:"Lead small from dummy and finesse the Q", explanation:"The AQ10 combination is a strong tenace. Finessing the Queen is the most effective way to establish three tricks if the King is onside.", points:15 },
    { type:"play", contract:"3NT", declarer:"South", lead:"♠6", dummy:{spades:"K73",hearts:"A74",diamonds:"53",clubs:"865"}, hand:{spades:"A84",hearts:"K65",diamonds:"KJ102",clubs:"KQ4"}, question:"West leads ♠6. You win ♠A. In diamonds, you hold KJ102 in hand and 53 in dummy, missing the Ace and Queen. You need 2 tricks. What is the correct play?", options:["Lead small from dummy and finesse the K","Cash the King first","Lead the 10 from hand","Lead the Jack from hand"], correct:"Lead small from dummy and finesse the K", explanation:"The KJ10 combination allows you to win two tricks if the Ace is onside, by finessing the King from dummy.", points:15 },
  ],
